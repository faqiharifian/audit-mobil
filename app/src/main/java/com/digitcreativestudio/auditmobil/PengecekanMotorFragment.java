...
public class PengecekanMotorFragment extends Fragment {
    ...
    public static PengecekanMotorFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.findViewById(R.id.lanjut_image_view).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                trans.replace(R.id.root_frame, new PengecekanKnalpotFragment());
